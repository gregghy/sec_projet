...
import { Bell, User, Gavel, Clock, Search, LogOut, Plus, X, ShieldAlert } from 'lucide-react';
...
const Navbar = ({ user, onLoginClick, onLogout, onCreateClick, onAccountClick, onHackerClick }) => (
  <nav className="bg-slate-900 text-white p-4 shadow-md">
    <div className="w-full px-4 flex justify-between items-center">
      ...
      <div className="flex items-center space-x-6">
        <button onClick={onHackerClick} className="text-red-500 hover:text-red-400 transition flex items-center gap-1" title="Hacker Panel">
            <ShieldAlert size={20} />
        </button>
  ...
  return (
    <div className="h-screen flex flex-col bg-white">
      <Navbar
        ...
        onHackerClick={() => setShowHackerPanel(!showHackerPanel)}
      />

      <HackerPanel 
        api={api} 
        isOpen={showHackerPanel} 
